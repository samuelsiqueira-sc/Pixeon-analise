...
namespace CRM.Pixeon.Extends.Plugins
{
    /// <summary>
    ...
    public abstract class PluginBase : IPlugin
    {
        ...
        protected class LocalPluginContext
        {
            ...
            internal string GetLanguageCode()
            {
                ...
                {
                    int? languageCode = orgContext.UserSettingsSet.Where(w => w.SystemUserId == PluginExecutionContext.InitiatingUserId).Select(s => s.UILanguageId).FirstOrDefault();
