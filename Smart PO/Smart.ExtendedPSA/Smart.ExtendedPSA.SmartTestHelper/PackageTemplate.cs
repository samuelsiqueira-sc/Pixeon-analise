...
namespace CRMPackageDeploymentTemplate
{
    /// <summary>
    ...
    public class PackageTemplate : ImportExtension
    {
        ...
        {
            get { return "Pacote de Instalação responsável por aplicar recursos que auxiliem na criação e Testes Unitários."; }
        }
        ...
        {
            get { return "Smart Test Helper - Smart Consulting"; }
        }
