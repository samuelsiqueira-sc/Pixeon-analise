...
namespace Smart.ExtendedPSA.Extends.Plugins.smt_type_hours
{
    ...
    /// Iniciaçaõ da Classe
    /// </summary>
    public class PreCreateSync_smt_type_hours : PluginBase
    {
        /// <summary>
        /// PreCreateSync_smt_type_hours
        /// </summary>
        public PreCreateSync_smt_type_hours() : base(typeof(PreCreateSync_smt_type_hours)) { }
