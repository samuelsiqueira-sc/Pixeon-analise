...
namespace Smart.ExtendedPSA.Extends.Workflows
{
    ...
    public sealed class SendMail : CodeActivity
    {
        ...
        public InArgument<EntityReference> HolidayRequest { get; set; }
        ...
        protected override void Execute(CodeActivityContext executionContext)
        {
            ...
            var holiday = HolidayRequest.Get(executionContext);
            ...
            using (var orgContext = new OrganizationServiceContext(service))
            {
                ...
                // throw new InvalidPluginExecutionException(CheckTeam.Count.ToString());
                if (CheckSmartParameters != null)
                {
                    ...
                    else
                    {
                        ...
                        log.smt_st_entityname = $"Solicitação de Férias (smt_holiday_request)";
                        ...
                        log.smt_st_recordid = holiday.Id.ToString();
